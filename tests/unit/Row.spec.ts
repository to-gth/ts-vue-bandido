...
describe('Row', () => {
  ...
  // it('at', () => {
  //   const rows = [...Array(2)].map(() => Row.blank(2))
  //   // rows[0][0] = SquareFill.from(Direction.Left, Limb.L, false)
  //   rows[0][1] = SquareFill.from(Direction.Left, Limb.L)
  //   const top1 = Row.at(0, rows)
  //   expect(SquareBlank.accepts(top1![0]), 'at 00').to.be.true
  //   expect(SquareFill.accepts(top1![1]), 'at 01').to.be.true
  ...
  //   expect(SquareFill.accepts(bottom2![1]), 'at -21').to.be.true
  ...
  //   expect(SquareFill.accepts(ttop2![0]), 'at t10').to.be.true
  ...
  //   expect(SquareFill.accepts(tbottom1![0]), 'at t-10').to.be.true
